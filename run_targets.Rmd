...
If you are running with the configuration `run_GEE: FALSE` or as the default 
...
If the following python code chunk errors out with a "ModuleNotFoundError", please restart your
R session and re-run the previous code chunk before re-running the following python
chunk.
