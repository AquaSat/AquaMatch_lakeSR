...
lakeSR_WQP relies on this configuration file to run specific profiles that
...
methods. **Note: the Landsat Surface Reflectance product should not be used without
