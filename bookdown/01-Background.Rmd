...
This {targets} group saves the output of the -d- group, if the general lakeSR
configuration is set to do so. If `update_and_share` is set to TRUE, the workflow
will send dated, publicly available files to Google Drive and save Drive file 
information in the `f_save_to_Drive/out/` folder. If set to FALSE, this {targets}
list is empty.
