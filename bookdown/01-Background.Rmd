...
Hydrography Dataset Plut Version 2 ("NHDPlusV2") polygons using the
...
[@larsson2024]. We limit the inclusion of small intermittent waterbodies
...
for those in the continental United States ("CONUS") or NHD Best Resolution for
non-CONUS HUCs datasets where HUC8s were able to be assigned. This is a very
