...
interchangable due to the similarity in payload and radiometric resolution. Data
corrected to Landsat 8 relative values can only be applied to Landsat 7 and 9
due to mission overlap, so the standardized data timeseries is shorter.
...
![An example of two overlapping WRS2 paths (grey area) separated by one day. Any location with data for both images would be considered a paired data point to define the Roy method intermission handoffs.](images/path_overlap_roy.png)
...
When n is high, quantiles are equivalent to describing the central tendency of
the distribution of the x:y relationship due to the Central Limit Theorem.
...
### Roy Deming Correction Landsat 9 to Landsat 8
...
![](images/roy/handoffs/med_Blue_LS9_to_LS8_DSWE1_roy_handoff.jpg){width="600"}

![](images/roy/residuals/med_Blue_LS9_to_LS8_DSWE1_roy_deming_residuals.jpg){width="600"}

![](images/roy/handoffs/med_Green_LS9_to_LS8_DSWE1_roy_handoff.jpg){width="600"}

![](images/roy/residuals/med_Green_LS9_to_LS8_DSWE1_roy_deming_residuals.jpg){width="600"}

![](images/roy/handoffs/med_Red_LS9_to_LS8_DSWE1_roy_handoff.jpg){width="600"}

![](images/roy/residuals/med_Red_LS9_to_LS8_DSWE1_roy_deming_residuals.jpg){width="600"}

![](images/roy/handoffs/med_Nir_LS9_to_LS8_DSWE1_roy_handoff.jpg){width="600"}

![](images/roy/residuals/med_Nir_LS9_to_LS8_DSWE1_roy_deming_residuals.jpg){width="600"}

![](images/roy/handoffs/med_SurfaceTemp_LS9_to_LS8_DSWE1_roy_handoff.jpg){width="600"}

![](images/roy/residuals/med_SurfaceTemp_LS9_to_LS8_DSWE1_roy_deming_residuals.jpg){width="600"}
...
gardner_handoff_table <- tibble("Early mission" = c("Landsat 5", "Landsat 7", "Landsat 8"),
                                ...
                                "Correction to" = c("Landsat 7", "Landsat 7, Landsat8", "Landsat 8"),
...
### Gardner Correction Landsat 9 to Landsat 8
...
![](images/gardner/handoffs/med_Blue_LS9_to_LS8_DSWE1_gard_handoff.jpg){width="600"}

![](images/gardner/residuals/med_Blue_LS9_to_LS8_DSWE1_gard_residuals.jpg){width="600"}

![](images/gardner/handoffs/med_Green_LS9_to_LS8_DSWE1_gard_handoff.jpg){width="600"}

![](images/gardner/residuals/med_Green_LS9_to_LS8_DSWE1_gard_residuals.jpg){width="600"}

![](images/gardner/handoffs/med_Red_LS9_to_LS8_DSWE1_gard_handoff.jpg){width="600"}

![](images/gardner/residuals/med_Red_LS9_to_LS8_DSWE1_gard_residuals.jpg){width="600"}

![](images/gardner/handoffs/med_Nir_LS9_to_LS8_DSWE1_gard_handoff.jpg){width="600"}

![](images/gardner/residuals/med_Nir_LS9_to_LS8_DSWE1_gard_residuals.jpg){width="600"}

![](images/gardner/handoffs/med_SurfaceTemp_LS9_to_LS8_DSWE1_gard_handoff.jpg){width="600"}

![](images/gardner/residuals/med_SurfaceTemp_LS9_to_LS8_DSWE1_gard_residuals.jpg){width="600"}
