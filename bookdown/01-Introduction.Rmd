...
points created in `a_Calculate_Centers`. **Note**: this group of targets takes a
very, very long time, averaging about 1 hour per path-row branch. There are just
under 800 path rows executed in this branch.
...
and Section \@ref(LS-SRST-pull) and detailed methodology.
