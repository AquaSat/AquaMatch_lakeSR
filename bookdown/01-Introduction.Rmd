...
(v2) suite, an effort to create a database of lake and river water quality
observations alongside remote sensing data.

Currently, **lakeSR** is comprised of the historical Landsat record from 1984
until mid-2024, comprised of data from the following missions:
...
`lakeSR.rproj` open in your RStudio console.
