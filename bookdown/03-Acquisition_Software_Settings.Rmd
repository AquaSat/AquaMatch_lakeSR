...
In order to run any GEE-related targets, you will need to have a Google Earth
Engine account (see \@ref(create-account)), a Google Earth Engine Cloud Project
(described in \@ref(proj-setting)) , gcloud CLI set up on your computer (see
\@ref(gcloud)), and you will need to alter the configuration file (described in
\@ref(proj-setting)).
