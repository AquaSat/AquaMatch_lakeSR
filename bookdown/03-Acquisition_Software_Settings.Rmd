...
environment. In AquaSat v2, we use [a singular R
...
to update the config yaml
(`b_pull_Landsat_SRST_poi/config_files/config_poi.yml`) with your Google
credentials and GEE project in order to run this locally. A blank yml file
(`b_pull_Landsat_SRST_poi/config_files/config.yml`) is provided for further
customization. If you are new to GEE, go to
