...
unifying for reliable RS data across the US and Territories. Figures in the
sections below show how many rows of data were dropped through this QA process.
For the purposes of this documentation, we show summaries for DSWE1 data only,
but running the pipeline locally results in summaries for both DSWE1 and DSWE1a
data.

### Landsat 4 QA Summary

![Summary of dropped rows for lakeSR Landsat 4's DSWE1 (confident water) RS
summaries.](images/lakeSR/LT04_dswe1_drop_summary.png){#fig:lake-ls4-dswe1-drop}

![Summary of dropped rows for siteSR Landsat 4's DSWE1 (confident water) RS
summaries.](images/siteSR/LT04_dswe1_drop_summary.png){#fig:site-ls4-dswe1-drop}

### Landsat 5 QA Summary

![Summary of dropped rows for lakeSR Landsat 5's DSWE1 (confident water) RS
summaries.](images/lakeSR/LT05_DSWE1_drop_summary.png){#fig:lake-ls5-dswe1-drop}

![Summary of dropped rows for siteSR Landsat 5's DSWE1 (confident water) RS
summaries.](images/siteSR/LT05_DSWE1_drop_summary.png){#fig:site-ls5-dswe1-drop}

### Landsat 7 QA Summary

![Summary of dropped rows for lakeSR Landsat 7's DSWE1 (confident water) RS
summaries.](images/lakeSR/LE07_DSWE1_drop_summary.png){#fig:lake-ls7-dswe1-drop}

![Summary of dropped rows for siteSR Landsat 7's DSWE1 (confident water) RS
summaries.](images/siteSR/LE07_DSWE1_drop_summary.png){#fig:site-ls7-dswe1-drop}
...
summaries.](images/siteSR/LC09_DSWE1_drop_summary.png){#fig:site-ls9-dswe1-drop}
