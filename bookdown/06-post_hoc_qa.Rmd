...
-   image quality (acquired from scene-level metadata files) must be \>= 8. In
    ...
    `IMAGE_QUALITY_OLI`. These column indicate the overall quality of the image
...
![Summary of rows retained during lakeSR quality filtering for Landsat 4 DSWE1
(confident water) remote sensing
summaries.](images/siteSR/LT04_DSWE1_drop_summary.png){#fig:site-ls9-dswe1-drop
alt="Summary of rows retained during siteSR Landsat 9's quality filtering for DSWE1 (confident water) remote sensing summaries."}

![Summary of rows retained during siteSR quality filtering for Landsat 4 DSWE1
(confident water) remote sensing
summaries.](images/siteSR/LT04_DSWE1_drop_summary.png){alt="Summary of rows retained during siteSR Landsat 9's quality filtering for DSWE1 (confident water) remote sensing summaries."}

### Landsat 5 QA Summary

![Summary of rows retained during lakeSR quality filtering for Landsat 5 DSWE1
(confident water) remote sensing
summaries.](images/siteSR/LT05_DSWE1_drop_summary.png){alt="Summary of rows retained during siteSR Landsat 9's quality filtering for DSWE1 (confident water) remote sensing summaries."}

![Summary of rows retained during siteSR quality filtering for Landsat 5 DSWE1
(confident water) remote sensing
summaries.](images/siteSR/LT05_DSWE1_drop_summary.png){alt="Summary of rows retained during siteSR Landsat 9's quality filtering for DSWE1 (confident water) remote sensing summaries."}

### Landsat 7 QA Summary

![Summary of rows retained during lakeSR quality filtering for Landsat 7 DSWE1
(confident water) remote sensing
summaries.](images/siteSR/LE07_DSWE1_drop_summary.png){alt="Summary of rows retained during siteSR Landsat 9's quality filtering for DSWE1 (confident water) remote sensing summaries."}

![Summary of rows retained during siteSR quality filtering for Landsat 7 DSWE1
(confident water) remote sensing
summaries.](images/siteSR/LE07_DSWE1_drop_summary.png){alt="Summary of rows retained during siteSR Landsat 9's quality filtering for DSWE1 (confident water) remote sensing summaries."}
...
![Summary of rows retained during siteeSR quality filtering for Landsat 9 DSWE1
(confident water) remote sensing
