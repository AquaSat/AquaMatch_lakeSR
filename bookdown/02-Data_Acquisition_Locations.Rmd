...
were deemed to be visible by remote sensing (`r round(abs((nrow(p5_visible_sites)-nrow(p4_WQP_site_NHD_info))/nrow(p4_WQP_site_NHD_info)*100), 1)`% loss of sites).
...
>
> 1: point within GEE buffer distance (default 200 meters for siteSR) of the
> NHD waterbody
>
...
these sites as well, but with the siteSR default site buffer of 200 meters instead of
lakeSR's buffer of 120 meters.
...
>
> 1: point between 100 meters and GEE buffer distance (default 200 meters for siteSR)
> to nearest flowline
>
...
shoreline contamination) and NHD comid/permanent id attribution to individual sites.
