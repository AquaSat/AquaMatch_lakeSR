...
```{r v1-WI-lakes, echo=F, fig.cap="Deepest point of Wisconsin lakes included in AquaSat v1, defined by the Hydrolakes data product. Deepest point for each lake is indicated with a black dot."}
tm_shape(WI_for_viz) +
  tm_borders() +
  tm_shape(WI_HL) +
  tm_fill("lightblue") +
...
```{r v2-WI-lakes, fig.cap="Point of inaccessibility for Wisconsin lakes included in AquaSat v2, defined by the NHDPlusV2 data product. Point of inaccessibility for each lake is indicated with a black dot."}
tm_shape(WI_for_viz) +
  tm_borders() +
  tm_shape(WI_wbd_poi) +
  tm_fill("lightblue") +
