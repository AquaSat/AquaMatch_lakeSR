...
important to note that the `poi()` function does not perform particularily well
...
## Where to find these decisions employed in the code
...
[a_Calculate_Centers.R](https://github.com/steeleb/lakeSR/blob/main/a_Calculate_Centers.R).
...
the script
[calculate_centers_HUC4.R](https://github.com/rossyndicate/lakeSR/blob/main/a_Calculate_Centers/src/calculate_centers_HUC4.R)
...
script
[calculate_AK_poi.R](https://github.com/rossyndicate/lakeSR/blob/main/a_Calculate_Centers/src/calculate_AK_poi.R))
...
[collate_NHDHR_AK.R](https://github.com/rossyndicate/lakeSR/blob/main/a_Calculate_Centers/src/collate_NHDHR_AK.R),
