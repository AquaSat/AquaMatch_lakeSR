...
Site information, NHD attribution, and associated flags are stored in the file
\`\`. We provide these identifiers and additional metadata about the sites to
help users make informed decisions about remote sensing data quality
(specifically, related to edge/ shoreline contamination) and NHD comid/permanent
id attribution to individual sites.
