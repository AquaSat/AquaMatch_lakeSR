...
+--------------+-------------+--------------+--------------+--------------+
| Mission and  | Launch Date | End of       | Decommission | D a t e R a  |
| Sensor       |             | Science      | Date         | n g e I n c  |
|              |             | Mission      |              | l u d e d i  |
|              |             |              |              | n A q u a M  |
|              |             |              |              | a t c h      |
+==============+:===========:+:============:+:============:+:============:+
| Landsat 4 TM | 1982-07-16  | 1993-12-14   | 2001-06-15   | -   L a u n  |
| [@eros-45]   |             |              |              |     c h d a  |
|              |             |              |              |     t e      |
|              |             |              |              | -   t h r o  |
|              |             |              |              |     u g h    |
...
|              |             |              |              | -            |
+--------------+-------------+--------------+--------------+--------------+
| Landsat 5 TM | 1984-03-01  | 2011-11-18   | 2013-06-05   | -   L a u n  |
| [@eros-45]   |             |              |              |     c h d a  |
|              |             |              |              |     t e      |
|              |             |              |              | -   t h r o  |
|              |             |              |              |     u g h    |
...
|              |             |              |              | -            |
+--------------+-------------+--------------+--------------+--------------+
| Landsat 7    | 1999-04-15  | 2022-04-06   | 2025-06-04   | 1 9 9 9 - 0  |
| ETM+         |             |              |              | 5 - 2 8      |
| [@eros-7]    |             |              |              |              |
|              |             |              |              | -   2 0 1 9  |
|              |             |              |              | -   1 2      |
|              |             |              |              | -   3 1      |
+--------------+-------------+--------------+--------------+--------------+
| Landsat 8    | 2013-02-11  | N/A          | N/A          | L a u n c h  |
| OLI/TIRS     |             |              |              | d a t e t h  |
| [@eros-89]   |             |              |              | r o u g h m  |
|              |             |              |              | o s t r e c  |
|              |             |              |              | e n t i m a  |
|              |             |              |              | g e a v a i  |
...
|              |             |              |              | n G E E      |
+--------------+-------------+--------------+--------------+--------------+
| Landsat 9    | 2021-09-27  | N/A          | N/A          | L a u n c h  |
| OLI-2/TIRS-2 |             |              |              | d a t e t h  |
| [@eros-89]   |             |              |              | r o u g h m  |
|              |             |              |              | o s t r e c  |
|              |             |              |              | e n t i m a  |
|              |             |              |              | g e a v a i  |
...
[@usgs_c2_l1_tm, @usgs_c2_l1_etm], OLI data are quantized to 12 bits [@usgs_oli]
and Landsat 9 to 14 bits [@usgs_oli2]. This equates to 256 shades per band for
Landsat 4-7 (2^8^), 4,096 shades for Landsat 8 (2^12^) and 16,384 shades for
Landsat 9 (2^14^), where higher numbers allow for greater precision of
measurement in a given band. All Collection 2 Level 2 Surface Reflectance and
Surface Temperature data have been rescaled and stored as unsigned 16 bit values
(range for SR and ST bands are are 65536 shades, or 2^16^). Since Collection 2
rescaling to a higher number of bits creates false precision across all
satellites, we truncate the surface reflectance values to three significant
digits for Landsat 4 - 7, four digits for Landsat 8, and five digits for Landsat
9.
...
discrete analysis of temperature trends/patterns. @king2024 noted that handoff
