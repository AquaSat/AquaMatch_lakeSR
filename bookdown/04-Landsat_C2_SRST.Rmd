...
# Landsat Collection 2 SR & ST {#LS-C2-SRST}
...
available as a Portable Document Format ("PDF") download
...
+---------------+---------------+---------------+---------------+---------------+
| Mission and   | Launch Date   | End of        | Decommission  | Date Range    |
| Sensor        |               | Science       | Date          | Included in   |
|               |               | Mission       |               | AquaMatch     |
+===============+:=============:+:=============:+:=============:+===============+
| Landsat 4 TM  | 1982-07-16    | 1993-12-14    | 2001-06-15    | Launch Date   |
| [@eroscenter] |               |               |               | through End   |
|               |               |               |               | of Science    |
|               |               |               |               | Mission       |
+---------------+---------------+---------------+---------------+---------------+
| Landsat 5 TM  | 1984-03-01    | 2011-11-18    | 2013-06-05    | Launch Date   |
| [@eroscenter] |               |               |               | through End   |
|               |               |               |               | of Science    |
|               |               |               |               | Mission       |
+---------------+---------------+---------------+---------------+---------------+
| Landsat 7     | 1999-04-15    | 2022-04-06    | 2025-06-04    | 1999-05-28    |
| ETM+          |               |               |               | through       |
| [@eros1999]   |               |               |               | 2019-12-31    |
+---------------+---------------+---------------+---------------+---------------+
| Landsat 8     | 2013-02-11    | N/A           | N/A           | Launch Date   |
| OLI/TIRS      |               |               |               | through       |
| [@eros2013]   |               |               |               | 2024-12-31    |
+---------------+---------------+---------------+---------------+---------------+
| Landsat 9     | 2021-09-27    | N/A           | N/A           | Launch Date   |
| OLI-2/TIRS-2  |               |               |               | through       |
| [@eros2013]   |               |               |               | 2024-12-31    |
+---------------+---------------+---------------+---------------+---------------+
...
(e.g. B1 (band 1), B2 (band 2), B3 (band 3), etc) to an assigned name (e.g.
Blue, Green, Red, Landsat 4-7, but Aerosol, Blue, Green for Landsat 8/9) within
the Google Earth Engine script and prior to exporting data for inclusion in this
workflow. The table below denotes how these designations have been applied in
AquaMatch.
...
+-------------------------+-------------------------+-------------------------+
| B5                      | Shortwave Infrared 1    | Near Infrared "NIR"     |
|                         | "SWIR1"                 |                         |
+-------------------------+-------------------------+-------------------------+
| B6                      | Thermal Band            | Shortwave Infrared 1    |
|                         |                         | "SWIR1"                 |
+-------------------------+-------------------------+-------------------------+
| B7                      | Shortwave Infrared 2    | Shortwave Infrared 2    |
|                         | "SWIR2"                 | "SWIR2"                 |
+-------------------------+-------------------------+-------------------------+
| B8                      | Panchromatic band (not  | Panchromatic (not       |
|                         | available for Landsat   | included in AquaMatch)  |
|                         | 4, not included in      |                         |
|                         | AquaMatch)              |                         |
+-------------------------+-------------------------+-------------------------+
| B9                      | N/A                     | Cirrus (not included in |
|                         |                         | AquaMatch               |
+-------------------------+-------------------------+-------------------------+
| B10                     | N/A                     | Thermal Band 1          |
+-------------------------+-------------------------+-------------------------+
| B11                     | N/A                     | Thermal Band 2 (not     |
|                         |                         | included in AquaMatch)  |
+-------------------------+-------------------------+-------------------------+
...
derived from has not changed for optical bands over time (Aerosol, Red, Green,
Blue, NIR, SWIR) but has varied over the historic record for thermal data:
...
time. The USGS Earth Resources Observation and Science ("EROS") Center describes
the SR product as follows:
...
Disturbance Adaptive Processing System ("LEDAPS") [@schmidt2013] and Landsat 8
and 9 SR data are calculated using the Land Surface Reflectance Code ("LaSRC")
...
The Landsat Collection 2 Surface Temperature product is calculated using a
